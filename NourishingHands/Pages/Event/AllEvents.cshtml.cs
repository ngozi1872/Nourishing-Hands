...
namespace NourishingHands.Pages.Event
{
    public class AllEventsModel : PageModel
    {
        ...
        public AllEventsModel(NourishingHandsContext dbContext, UserManager<IdentityUser> userManager, IWebHostEnvironment hostEnvironment)
        {
        ...
        public void OnGet()
        {
            ...
            var eventn = _dbContext.Events
                  .Where(s => s.EventStartDate >= DateTime.Now)
                  .OrderBy(t => t.EventStartDate).FirstOrDefault();
        ...
        public IActionResult OnGetFindAllEvents()
        {
            var events = _dbContext.Events
                .Where(ev => ev.EventStartDate >= DateTime.Now)
                .Select(e => new
                    {
                        id = e.Id,
                        title = e.Name,
